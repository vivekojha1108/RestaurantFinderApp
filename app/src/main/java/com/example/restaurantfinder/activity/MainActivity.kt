...
import com.example.restaurantfinder.adapter.MainAdapter
import com.example.restaurantfinder.adapter.MainAdapterHorizontal
import com.example.restaurantfinder.api.ApiEndpoint
import com.example.restaurantfinder.model.ModelMain
import com.example.restaurantfinder.model.ModelMainHorizontal
import com.example.restaurantfinder.utils.OnItemClickCallback
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchRestaurant.setQueryHint("Search Restaurant")
        ...
        val searchPlateId = searchRestaurant.getContext()
            .resources.getIdentifier("android:id/search_plate", null, null)
        val searchPlate = searchRestaurant.findViewById<View>(searchPlateId)
    ...
    private fun showRecyclerResto() {
        ...
        mainAdapter?.setOnItemClickCallback(object :
            ...
            override fun onItemMainClicked(modelMain: ModelMain?) {
                ...
                intent.putExtra(DetailsActivity.DETAIL_RESTO, modelMain)
    ...
    private fun setSearchResto(query: String) {
        mProgressBar?.show()
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.SearchRestaurant + query + "&lat=" + lat + "&lon=" + lng + "&radius=20000")
